...
this.browser = new Browser({ stock: false, hidden: false, channel: "", mode: "", name: "Chrome", version: new Version({ value: "43.0.2357.81", details: 1 }) });
this.engine = new Engine({ name: "Blink", version: new Version({ value: "537.36" }) });
this.os = new Os({ name: "OS X", version: new Version({ value: "10.9.2", details: 2, nickname: "Mavericks" }) });
